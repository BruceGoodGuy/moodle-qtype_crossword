...
class qtype_crossword_test_helper extends question_test_helper {
    ...
    public function get_crossword_question_form_data_sampleimage() {
        ...
        $fromform->hint = [
            ['text' => 'This is the first hint. <img src="@@PLUGINFILE@@/hint1.jpg"', 'format' => FORMAT_HTML],
            ['text' => 'This is the second hint. <img src="@@PLUGINFILE@@/hint2.jpg', 'format' => FORMAT_HTML],
        ];
